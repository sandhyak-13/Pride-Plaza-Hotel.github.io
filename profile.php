...
?>
<div class="container-fluid"id="primary" style="background-color:white"><!--Primary Id-->
  <center><h1 style="background-color:grey;border-radius:70px;, cursive;box-shadow:9px 5px 9px black; color:white;display:inline-block;">User Profile</h1></center><br>
  <div class="container">
    <div class="row">
