...
<div class="container-fluid"style="background-color:white;color:black;"> <!-- Primary Id-->


  <div class="container" style="background-img:url('image/devlop/logo.png')">
    <div class="row">
 <br>     <center><h1 ><b><font color="#080808"><u>Create New Account</u></font></b></h1></center>
      ...
      <div class="col-sm-6 ">
        ...
        <div class="form-group">
		  ...
		  <div class="row">
            ...
            <input type="submit" value="Submit" name="save" required style="color:black, height:60px; width:100px;"/>
          </div>
        </div>
      </div>
	  </form>
