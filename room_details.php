...
<body style="margin-top:50px;">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="image/image_gallery/1.jpeg"class="thumbnail" alt="img1">
    </div>

    <div class="item">
      <img src="image/image_gallery/4.jpeg"class="thumbnail" alt="im2">
    </div>

    <div class="item">
       <img src="image/image_gallery/11.jpg"class="thumbnail" alt="im3">
    </div>

    <div class="item">
       <img src="image/image_gallery/2.jpg"class="thumbnail" alt="img4">
    </div>

    <div class="item">
       <img src="image/image_gallery/9.jpg"class="thumbnail" alt="img5">
    </div>

    <div class="item">
       <img src="image/image_gallery/12.jpg"class="thumbnail" alt="img7">
    </div>
  </div>
...
?>
    ...
    <div class="row">
      ...
      <a href="booking.php" class="btn btn-danger">Book Now</a><br><br>
      </div>
	</div>
				<div class="col-sm-3">
